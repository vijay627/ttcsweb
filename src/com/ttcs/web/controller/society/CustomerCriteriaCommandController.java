...
public class CustomerCriteriaCommandController extends AbstractTtcsCommandController {
 	
	private static final Logger log = Logger.getLogger(CustomerCriteriaCommandController.class);
