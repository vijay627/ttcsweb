...
import com.ttcs.commons.exception.TtcsSystemException;
...
public class CommandExecutor implements CommandExecutorInterface, BeanFactoryAware {
	...
	private static String FDT_PACKAGE = "com.ttcs.commons.pojo.";
	 ...
	 * @throws TtcsException 
	 */
	public Serializable execute(Serializable commandData) throws TtcsException {
		...
		try {
			...
			if (e.getTargetException() instanceof TtcsException) {
				throw (TtcsException) e.getTargetException();
			}
			throw new TtcsSystemException(e.getTargetException(), "system.generic");
			
		} catch (Throwable e) {
			LOGGER.error(e.getMessage(), e);
			throw new TtcsSystemException(e, "system.generic");
		}
		return returnValue;
	}
