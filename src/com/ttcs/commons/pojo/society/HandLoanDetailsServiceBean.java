...
public class HandLoanDetailsServiceBean implements Bean{
	...
	private List<HLEMIBreakupServiceBean> HLEMIBreakupServiceBeanList;
	
	private HLEMIBreakupServiceBean[] breakupBeanArray;

	public HLEMIBreakupServiceBean[] getBreakupBeanArray() {
		
		                                      
		return breakupBeanArray;
	}

	public void setBreakupBeanArray(HLEMIBreakupServiceBean[] breakupBeanArray) {
		
		if(numberOfinstallments != null){
			this.breakupBeanArray = new HLEMIBreakupServiceBean[numberOfinstallments.intValue()];
		}
		
		this.breakupBeanArray = breakupBeanArray;
	}

	public List<HLEMIBreakupServiceBean> getHLEMIBreakupServiceBeanList() {
		return HLEMIBreakupServiceBeanList;
	}

	public void setHLEMIBreakupServiceBeanList(
			List<HLEMIBreakupServiceBean> breakupServiceBeanList) {
		HLEMIBreakupServiceBeanList = breakupServiceBeanList;
	}
