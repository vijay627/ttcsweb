...
public class PersonalLoanDetailsServiceBean implements Bean{
	...
	private List<PLEMIBreakupServiceBean> PLEMIBreakupServiceBeanList;
	
	private PLEMIBreakupServiceBean[] breakupBeanArray;

	public PLEMIBreakupServiceBean[] getBreakupBeanArray() {
		
		                                      
		return breakupBeanArray;
	}

	public void setBreakupBeanArray(PLEMIBreakupServiceBean[] breakupBeanArray) {
		
		if(numberOfinstallments != null){
			this.breakupBeanArray = new PLEMIBreakupServiceBean[numberOfinstallments.intValue()];
		}
		
		this.breakupBeanArray = breakupBeanArray;
	}

	public List<PLEMIBreakupServiceBean> getPLEMIBreakupServiceBeanList() {
		return PLEMIBreakupServiceBeanList;
	}

	public void setPLEMIBreakupServiceBeanList(
			List<PLEMIBreakupServiceBean> breakupServiceBeanList) {
		PLEMIBreakupServiceBeanList = breakupServiceBeanList;
	}
