...
import com.ttcs.commons.exception.TtcsPersistenceException;





public class TtcsDao extends HibernateDaoSupport {
	
	
	public static final String TTCS_TEST_DETAILS_SEQ = "TTCS_TEST_DETAILS_SEQ";
	...
	/** The Constant log. */
	private static final Log LOG = LogFactory.getLog(TtcsDao.class);
 	 ...
 	 * @throws TtcsPersistenceException the ttcs persistence exception
 	 */
    public Object load(final Serializable oid, final Class referencedClass)
            throws TtcsPersistenceException {
        Object object = null;
        try {
            ...
            TtcsPersistenceException newex = new TtcsPersistenceException(msg, rfex.getCause(),
                    "");
            throw newex;
            ...
            TtcsPersistenceException newex = new TtcsPersistenceException(msg, ex.getCause(),
                    "");
            throw newex;
        } 
        return object;
	 ...
	 * @throws TtcsPersistenceException the ttcs persistence exception
	 */
   public void save(final Object object) throws TtcsPersistenceException {
       try {
           /**
    ...
    * @throws TtcsPersistenceException the ttcs persistence exception
    */
   public void remove(final Object object) throws TtcsPersistenceException {       
       try {
